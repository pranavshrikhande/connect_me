  ...
  return (
    <div className='bg-white rounded-md shadow-md text-gray-500 p-2'>
        ...
        <form className='flex flex-1'>
            ...
            <input className="rounded-full h-12 flex-grow focus:outline-non font-medium bg-gray-100 px-4" 
             type="text"
             ref={inputRef}
             placeholder={`What's on your mind, ${session?.user.name.split(" ")[0]}?`}></input>
