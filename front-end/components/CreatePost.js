  ...
  return (
    <div className='bg-white rounded-md shadow-md text-gray-500 p-2'>
        ...
        <form className='flex flex-1'>
            ...
            <input type="text" className="rounded-full h-12 flex-grow focus:outline-non font-medium bg-gray-100 px-4"  placeholder={`What's on your mind, ${session?.user.name.split(" ")[0]}?`}></input>
